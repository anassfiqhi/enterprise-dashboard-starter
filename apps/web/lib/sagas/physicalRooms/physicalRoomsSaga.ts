...
export async function fetchPhysicalRoomsApi(
  hotelId: string,
  roomTypeId: string
...
export async function createPhysicalRoomApi(
  hotelId: string,
  roomTypeId: string,
  body: Partial<PhysicalRoom>
): Promise<PhysicalRoom> {
...
export async function updatePhysicalRoomApi(
  hotelId: string,
  roomTypeId: string,
  id: string,
  body: Partial<PhysicalRoom>
): Promise<PhysicalRoom> {
  return apiRequest<PhysicalRoom>(
    `/api/v1/hotels/${hotelId}/room-types/${roomTypeId}/rooms/${id}`,
    {
      method: 'PATCH',
      body,
    }
...
export async function deletePhysicalRoomApi(
  hotelId: string,
  roomTypeId: string,
  id: string
): Promise<void> {
...
export function* fetchPhysicalRoomsWorker(action: PayloadAction<FetchPhysicalRoomsPayload>) {
...
export function* createPhysicalRoomWorker(action: PayloadAction<CreatePhysicalRoomPayload>) {
...
export function* updatePhysicalRoomWorker(action: PayloadAction<UpdatePhysicalRoomPayload>) {
...
export function* deletePhysicalRoomWorker(action: PayloadAction<DeletePhysicalRoomPayload>) {
