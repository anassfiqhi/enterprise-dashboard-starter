...
export async function fetchHotelsList(): Promise<Hotel[]> {
...
export async function createHotelApi(input: CreateHotelPayload['input']): Promise<Hotel> {
...
export async function deleteHotelApi(hotelId: string): Promise<void> {
...
export async function deleteRoomTypeApi(hotelId: string, id: string): Promise<void> {
...
export async function deleteActivityTypeApi(hotelId: string, id: string): Promise<void> {
...
export function* fetchHotelWorker(action: PayloadAction<FetchHotelPayload>) {
...
export function* createHotelWorker(action: PayloadAction<CreateHotelPayload>) {
...
export function* updateHotelWorker(action: PayloadAction<UpdateHotelPayload>) {
...
export function* deleteHotelWorker(action: PayloadAction<DeleteHotelPayload>) {
...
export function* createRoomTypeWorker(action: PayloadAction<CreateRoomTypePayload>) {
...
export function* updateRoomTypeWorker(action: PayloadAction<UpdateRoomTypePayload>) {
...
export function* deleteRoomTypeWorker(action: PayloadAction<DeleteRoomTypePayload>) {
...
export function* createActivityTypeWorker(action: PayloadAction<CreateActivityTypePayload>) {
  const { hotelId, input, resolve, reject } = action.payload;
  try {
...
export function* updateActivityTypeWorker(action: PayloadAction<UpdateActivityTypePayload>) {
  const { id, hotelId, input, resolve, reject } = action.payload;
  try {
...
export function* deleteActivityTypeWorker(action: PayloadAction<DeleteActivityTypePayload>) {
  const { id, hotelId, resolve, reject } = action.payload;
  try {
