...
export async function fetchReservationsList(payload: FetchReservationsPayload): Promise<{
  data: Reservation[];
...
export async function fetchReservationDetail(id: string): Promise<ReservationWithPayments> {
...
export async function cancelReservationApi(id: string, reason?: string): Promise<Reservation> {
...
export async function refundReservationApi(
  id: string,
  amount?: number,
  reason?: string
): Promise<Payment> {
...
export function* fetchReservationsWorker(action: PayloadAction<FetchReservationsPayload>) {
  try {
...
export function* fetchReservationWorker(action: PayloadAction<FetchReservationPayload>) {
...
export function* createReservationWorker(action: PayloadAction<CreateReservationPayload>) {
...
export function* updateReservationStatusWorker(
  action: PayloadAction<UpdateReservationStatusPayload>
) {
...
export function* cancelReservationWorker(action: PayloadAction<CancelReservationPayload>) {
...
export function* refundReservationWorker(action: PayloadAction<RefundReservationPayload>) {
