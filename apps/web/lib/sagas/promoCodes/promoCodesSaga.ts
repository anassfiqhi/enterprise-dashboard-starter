...
} from '@/lib/reducers/promoCodes/promoCodesSlice';
...
export async function fetchPromoCodesApi(payload: FetchPromoCodesPayload): Promise<PromoCode[]> {
...
export async function createPromoCodeApi(
  hotelId: string,
  input: CreatePromoCodePayload['input']
): Promise<PromoCode> {
  return apiRequest<PromoCode>('/api/v1/promo-codes', {
    method: 'POST',
    body: { ...input, hotelId },
...
export async function updatePromoCodeApi(
  id: string,
  data: UpdatePromoCodePayload['data']
): Promise<PromoCode> {
...
export async function deletePromoCodeApi(id: string): Promise<void> {
...
export function* fetchPromoCodesWorker(action: PayloadAction<FetchPromoCodesPayload>) {
  try {
...
export function* validatePromoCodeWorker(action: PayloadAction<ValidatePromoCodePayload>) {
  try {
...
export function* createPromoCodeWorker(action: PayloadAction<CreatePromoCodePayload>) {
...
export function* updatePromoCodeWorker(action: PayloadAction<UpdatePromoCodePayload>) {
...
export function* deletePromoCodeWorker(action: PayloadAction<DeletePromoCodePayload>) {
