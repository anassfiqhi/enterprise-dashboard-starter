...
export async function fetchGuestDetail(guestId: string): Promise<GuestDetail> {
...
export async function deleteGuestApi(guestId: string): Promise<void> {
...
export function* fetchGuestsWorker(action: PayloadAction<FetchGuestsPayload>) {
...
export function* fetchGuestWorker(action: PayloadAction<FetchGuestPayload>) {
...
export function* createGuestWorker(action: PayloadAction<CreateGuestPayload>) {
...
export function* updateGuestWorker(action: PayloadAction<UpdateGuestPayload>) {
...
export function* deleteGuestWorker(action: PayloadAction<DeleteGuestPayload>) {
