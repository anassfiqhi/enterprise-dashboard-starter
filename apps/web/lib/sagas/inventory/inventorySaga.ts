...
export async function fetchInventory(payload: FetchInventoryPayload): Promise<RoomInventory[]> {
...
export async function updateInventoryApi(
  hotelId: string,
  updates: unknown[]
): Promise<{ data: RoomInventory[]; updatedCount: number }> {
...
export function* fetchInventoryWorker(action: PayloadAction<FetchInventoryPayload>) {
  try {
...
export function* updateInventoryWorker(action: PayloadAction<UpdateInventoryPayload>) {
